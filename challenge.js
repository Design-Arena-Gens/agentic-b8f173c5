...
var e = Object.defineProperty,
  t = (t, r, n) => {
    return (
      (o = n),
      (i = "symbol" != typeof r ? r + "" : r) in (s = t)
        ? e(s, i, { enumerable: !0, configurable: !0, writable: !0, value: o })
        : (s[i] = o)
    );
    var s, i, o;
  };
      ...
      return (
        ...
        function (s, i) {
          ...
          return new Promise(function (e, t) {
            var n = function (n) {
              var a =
                typeof Request < "u" && s instanceof Request ? s.clone() : s;
              r(a, i)
                .then(function (r) {
                ...
                .catch(function (e) {
                  ...
                  else n < o ? l(n, e, null) : t(e);
                });
            };
            function l(e, t, r) {
              var s = "function" == typeof a ? a(e, t, r) : a;
              setTimeout(function () {
                n(++e);
              }, s);
            }
...
class o {
  constructor(e) {
    t(this, "retryEnabled", !0);
    const {
      baseUrl: r,
      requestTimeout: n = 4e4,
      retryAttempts: s = 3,
      retryDelay: i = 1e4,
      retryOn: o,
      retryEnabled: a = !0,
    ...
    ((this.baseUrl = r),
      ...
      (this.retryEnabled = a),
      (this.retryConfig = { retries: s, retryDelay: i, retryOn: o }));
  }
  async get(e) {
    ...
    return new Promise((s, o) => {
      const a = new AbortController(),
        c = setTimeout(() => {
          (a.abort(`Request to ${e} was cancelled by timeout.`),
            o(new i(`Request to ${e} was cancelled by timeout.`)));
        }, this.requestTimeout),
        l = this.retryEnabled ? n(fetch) : fetch,
        d = {
          ...t,
          ...(this.retryEnabled && { ...this.retryConfig, ...r }),
          signal: a.signal,
          headers: {
      ...
      l(`${this.baseUrl}${e}`, d).then((e) => {
        (clearTimeout(c), s(e.json()));
      });
    });
  }
  async post(e) {
    ...
    return new Promise((s, o) => {
      const a = new AbortController(),
        c = setTimeout(() => {
          (a.abort(
            `Request to ${e} was cancelled by timeout in ${this.requestTimeout} ms.`,
          ),
            o(
              new i(
                `Request to ${e} was cancelled by timeout in ${this.requestTimeout} ms.`,
      ...
      l(`${this.baseUrl}${e}`, d).then(async (e) => {
        clearTimeout(c);
        const t = this.parseAnswer(e);
        s(t);
      });
    });
  }
  async parseAnswer(e) {
    const { status: t } = e;
    if (498 === t) {
      const { challenge: t } = await e.json();
      throw new r(t, "Request to solve next challenge");
    }
    let n = "";
    if (!String(t).startsWith("2")) {
      const t = e.headers.get("content-type");
      if (-1 !== (null == t ? void 0 : t.indexOf("application/json"))) {
        const t = await e.json();
        n = (null == t ? void 0 : t.message) ?? t;
      } else n = await e.text();
    }
    if (500 === t || 403 === t)
      throw new Error(n || "Something went wrong... try again.");
    if ("" !== n) throw new Error(n);
    return await e.json();
  }
}
var a = ((e) => ((e.CT = "CT"), (e.OTT = "OTT"), e))(a || {});
const c = (e) => {
    let t = 0;
  ...
  u = { tablet: "tablet", mobile: "mobile", desktop: "desktop", tv: "tv" },
  h = {
...
class g {
  ...
  static compareVersions(e, t, r = !1) {
    const n = g.getVersionPrecision(e),
      s = g.getVersionPrecision(t);
    let i = Math.max(n, s),
      o = 0;
    const a = g.map([e, t], (e) => {
      ...
      return g
        .map(r.split("."), (e) => new Array(20 - e.length).join("0") + e)
        .reverse();
    });
    for (r && (o = i - Math.min(n, s)), i -= 1; i >= o; ) {
...
const m = /version\/(\d+(\.?_?\d+)+)/i,
  f = [
    ...
    },
    {
      ...
      describe(e) {
        const t =
          -1 !== e.search("\\(") ? /^(.*)\/(.*)[ \t]\((.*)/ : /^(.*)\/(.*) /;
        return { name: g.getFirstMatch(t, e), version: g.getSecondMatch(t, e) };
      },
    },
  ],
  w = [
    ...
    },
    {
      ...
      describe(e) {
        ...
        return { name: h.WindowsPhone, version: t };
      },
    },
    {
      test: [/windows /i],
      describe(e) {
        const t = g.getFirstMatch(/Windows ((NT|XP)( \d\d?.\d)?)/i, e),
          r = g.getWindowsVersionName(t);
        return { name: h.Windows, version: t, versionName: r };
      },
    },
    {
    ...
    },
    {
      ...
      describe(e) {
        const t = g
            ...
            .replace(/[_\s]/g, "."),
          r = g.getMacOSVersionName(t),
          n = { name: h.MacOS, version: t };
    ...
    },
    {
      ...
      describe(e) {
        const t = g.getFirstMatch(/android[\s/-](\d+(\.\d+)*)/i, e),
          r = g.getAndroidVersionName(t),
          n = { name: h.Android, version: t };
        return (r && (n.versionName = r), n);
      },
    },
    {
    ...
    },
    {
      ...
      describe(e) {
        ...
        return { name: h.BlackBerry, version: t };
      },
    },
    {
      test: [/bada/i],
    ...
    },
    {
      ...
      describe(e) {
        ...
        return { name: h.Tizen, version: t };
      },
    },
    { test: [/linux/i], describe: () => ({ name: h.Linux }) },
    { test: [/CrOS/], describe: () => ({ name: h.ChromeOS }) },
    {
      test: [/PlayStation 4/],
      describe(e) {
        const t = g.getFirstMatch(/PlayStation 4[/\s](\d+(\.\d+)*)/i, e);
        return { name: h.PlayStation4, version: t };
      },
    },
  ],
  y = [
    ...
    },
    {
      ...
      describe(e) {
        const t = g.getFirstMatch(/(can-l01)/i, e) && "Nova",
          r = { type: u.mobile, vendor: "Huawei" };
        return (t && (r.model = t), r);
      },
    },
    {
      test: [/nexus\s*(?:7|8|9|10).*/i],
      describe: () => ({ type: u.tablet, vendor: "Nexus" }),
    },
    {
      test: [/ipad/i],
      describe: () => ({ type: u.tablet, vendor: "Apple", model: "iPad" }),
    },
    {
      test: [/Macintosh(.*?) FxiOS(.*?)\//],
      describe: () => ({ type: u.tablet, vendor: "Apple", model: "iPad" }),
    ...
    { test: [/silk/i], describe: () => ({ type: u.tablet, vendor: "Amazon" }) },
    { test: [/tablet(?! pc)/i], describe: () => ({ type: u.tablet }) },
    {
      test(e) {
      ...
      describe(e) {
        ...
        return { type: u.mobile, vendor: "Apple", model: t };
      },
    },
    {
      test: [/nexus\s*[0-6].*/i, /galaxy nexus/i],
      describe: () => ({ type: u.mobile, vendor: "Nexus" }),
    },
    { test: [/[^-]mobi/i], describe: () => ({ type: u.mobile }) },
    {
      test: (e) => "blackberry" === e.getBrowserName(!0),
      describe: () => ({ type: u.mobile, vendor: "BlackBerry" }),
    },
    {
      test: (e) => "bada" === e.getBrowserName(!0),
      describe: () => ({ type: u.mobile }),
    },
    {
      test: (e) => "windows phone" === e.getBrowserName(),
      describe: () => ({ type: u.mobile, vendor: "Microsoft" }),
    },
    {
      test(e) {
    ...
    },
    {
      ...
      describe: () => ({ type: u.desktop, vendor: "Apple" }),
    },
    {
      test: (e) => "windows" === e.getOSName(!0),
      describe: () => ({ type: u.desktop }),
    },
    {
  ...
  b = [
    ...
    { test: [/(apple)?webkit\/537\.36/i], describe: () => ({ name: p.Blink }) },
    {
      test: [/(apple)?webkit/i],
      describe(e) {
...
class v {
  ...
  satisfies(e) {
    ...
    if (
      (Object.keys(e).forEach((i) => {
        ...
        "string" == typeof o
          ? ((n[i] = o), (s += 1))
          : "object" == typeof o && ((t[i] = o), (r += 1));
      }),
      r > 0)
    ) {
      const e = Object.keys(t),
        r = g.find(e, (e) => this.isOS(e));
      if (r) {
        const e = this.satisfies(t[r]);
        if (void 0 !== e) return e;
      }
      const n = g.find(e, (e) => this.isPlatform(e));
      if (n) {
  ...
  isBrowser(e, t = !1) {
    ...
    let n = e.toLowerCase();
    const s = g.getBrowserTypeByAlias(n);
  ...
  compareVersion(e) {
    ...
    if ("string" == typeof s)
      return (
        ...
        t.indexOf(g.compareVersions(s, r, n)) > -1
      );
  }
  isOS(e) {
...
const S = class {
  ...
  M = {
    ...
    browser_v: S.getBrowserVersion(),
    os: S.getOSName(),
    os_v: S.getOSVersion(),
    engine: S.getEngineName(),
  ...
  O = async (e) => {
    const t = (function (e) {
      ...
      n = await (async (e) =>
        ((e) => {
          const { attempts: t, interval: r, isLoadedCallback: n } = e;
            ...
            let i = 0,
              o = window.setInterval(() => {
                ...
                (r || i === t) &&
                  ...
                  (o = null),
                  r ? e(!0) : s(new Error("checkApiAttempts error")));
              }, r);
          });
        })({
          attempts: 3,
...
var _ = ((e) => ((e.INFO = "INFO"), (e.ERROR = "ERROR"), e))(_ || {});
class F {
  constructor(e) {
    const { httpService: t } = e;
    this.httpService = t;
  }
  async report(e, t) {
    ...
    const { chl: n, ...s } = r,
      ...
      h = `${t}::${"string" == typeof (g = e) ? g : JSON.stringify(g, Object.getOwnPropertyNames(g))}::ts-${Date.now()}`,
      p = {
        type: _.ERROR,
        message: h,
        ...
        platform: u,
        chl: n ?? void 0,
        extra: { ...("object" == typeof s && s) },
      };
    var g;
    JSON.stringify(p);
  }
}
const T = "X-Wbaas-Token",
  E = class e {
    constructor(r) {
      (t(this, "http", null),
        t(this, "features", null),
        t(this, "cookieName", null),
        t(this, "trackerPath", null),
        t(this, "trackerOpts", null),
        t(this, "tracker", null),
        t(this, "reportTimerId", void 0),
        t(this, "reportPeriodMs", 1e4));
      const { http: n, settings: s, cookieName: i } = r,
        {
          path: o,
          feat: a,
          throttleMs: c,
      ...
      if (!o)
        throw new Error(
          "Required constructor options are missing. Please check the documentation.",
        );
      if (window[e.instanceKey]) return window[e.instanceKey];
      ((window[e.instanceKey] = this),
        (this.http = n),
        (this.features = a ?? []),
        (this.cookieName = i),
        (this.trackerOpts = { throttleMs: c, maxPoints: l, autoStart: d }),
        (this.trackerPath = o),
        (this.reportPeriodMs = u ?? this.reportPeriodMs),
        (this.report = this.report.bind(this)));
    }
    async collect() {
      !Array.isArray(this.features) ||
        0 === this.features.length ||
        ((this.tracker = await this.ensureTracker()), this.startReporting());
    }
    async stop() {
      this.tracker &&
        (this.tracker.stop(),
    ...
    async startReporting() {
      var e;
      (await this.stop(),
        null == (e = this.tracker) || e.start(),
        (this.reportTimerId = setInterval(this.report, this.reportPeriodMs)));
    }
    async ensureTracker() {
      if (this.tracker) return this.tracker;
      const e = await O(this.trackerPath);
      return (
        (this.tracker = new e(this.features, this.trackerOpts)),
        this.tracker
      );
    }
    async report() {
      ...
      if (r && null != (e = this.tracker) && e.hasData) {
        const e = { ...this.tracker.getRaw(), time: Date.now() },
          n = this.encodeData(e, r),
          s = "firefox" === M.browser.toLocaleLowerCase(),
          i = { body: n, headers: { [T]: r }, ...(!s && { keepalive: !0 }) };
        (null == (t = this.http) || t.post("/api/v1/frontend-analytics", i),
          this.tracker.reset());
      }
    }
    encodeData(e, t) {
        ...
        const r = [],
          n = (function (e, t) {
            const r = "string" == typeof e,
              n = r ? C(e) : e,
              s = C(t);
            for (let i = 0; i < n.length; i++) n[i] = n[i] ^ s[i % s.length];
            return r ? n : String.fromCharCode.apply(String, n);
          })(e, t);
        for (let s = 0; s < n.length; s++) r.push(n[s].toString(16));
        return r.join(",");
      })(JSON.stringify(e), t);
...
t(E, "instanceKey", "ANALY_S_WB_KEY");
let B = E;
class P {
  constructor(e) {
    (t(this, "baseUrl", null),
      t(this, "siteKey", null),
      t(this, "sdkVersion", null),
      t(this, "cookieName", "x_wbaas_token"),
      t(this, "antibotHeaders", null),
      t(this, "settings", null),
      t(this, "httpService", null),
      t(this, "loggerService", null),
      t(this, "analyticsService", null),
      t(this, "challengeSolver", null));
    const { baseUrl: r, siteKey: n } = e;
    if (!r || !n)
      throw new Error(
        "Required constructor options are missing. Please check the documentation.",
      );
    if (
      ((P.instanceKey = ((s = e), `ANTI_SDK_WB_${c(JSON.stringify(s))}`)),
      window[P.instanceKey])
    )
      return window[P.instanceKey];
    var s;
    ((window[P.instanceKey] = this), this.init(e));
  }
  async init(e) {
    var t;
    const {
    ...
    try {
      ((this.createToken = this.createToken.bind(this)),
        (this.createOneTimeToken = this.createOneTimeToken.bind(this)),
        (this.baseUrl = r),
        (this.siteKey = n),
        (this.cookieName = d ?? this.cookieName),
        (this.sdkVersion = `js-front-${S.getPlatform().type}/3.0.1`),
        (this.antibotHeaders = {
          "X-Wb-Antibot-Key": this.siteKey,
          "X-Wb-Antibot-SDK-Version": this.sdkVersion,
        }));
      const e = {
        headers: this.antibotHeaders,
        baseUrl: r,
        requestTimeout: s,
        retryAttempts: i,
        retryDelay: a,
      ...
      ((this.loadSettings = (function (e) {
        let t = null;
        return function () {
          return t || ((t = e(...arguments).finally(() => (t = null))), t);
        };
      })(this.loadSettings.bind(this))),
        (this.httpService = new o(e)),
        (this.loggerService = new F({ httpService: this.httpService })),
        (this.analyticsService = await this.initAnalyticsService()),
        this.analyticsService.collect());
    } catch (u) {
      throw (null == (t = this.loggerService) || t.report(u, "init"), u);
    }
  }
  async createToken(e) {
    var t;
    try {
      return await this.createTokenWithRetries(
        e ?? {},
        a.CT,
        "/api/v1/create-token",
      );
    } catch (r) {
      const n = { chl: (null == e ? void 0 : e.challenge) ?? {} };
      throw (
        null == (t = null == this ? void 0 : this.loggerService) ||
          t.report(r, a.CT, n),
        r
      );
    }
  ...
  async createTokenWithRetries(e, t, n) {
    var s;
    this.challengeSolver ||
      (this.challengeSolver = await this.initChallengeSolver());
    try {
      const t = JSON.stringify(e ?? {}),
        { secureToken: r } = await (null ==
        (s = null == this ? void 0 : this.httpService)
          ? void 0
          : s.post(n, { body: t }));
      return this.challengeSolver.finish().then(() => r);
    } catch (i) {
      if (i instanceof r) {
        const r = await this.challengeSolver.solve(i.challenge),
          s = this.enrichPayload(e, r);
        return this.createTokenWithRetries(s, t, n);
      }
      throw (await this.challengeSolver.close(), i);
    }
  }
  enrichPayload(e, t) {
    const { secureToken: r } = e;
    return {
      ...(r && { secureToken: r }),
      ...(this.isOTTPayload(e) && { action: e.action, userScope: e.userScope }),
      ...t,
    };
  }
  isOTTPayload(e) {
  ...
  async initChallengeSolver() {
    ...
    const e = (await this.loadSettings()).solverPath;
    return new (await O(`${this.baseUrl}${e}`))(this.baseUrl);
  }
  async initAnalyticsService() {
    ...
    const n = {
      ...
      settings: {
        ...(null == (e = this.settings) ? void 0 : e.analytics),
        path: `${this.baseUrl}${null == (r = null == (t = this.settings) ? void 0 : t.analytics) ? void 0 : r.path}`,
      },
    };
    return ((this.analyticsService = new B(n)), this.analyticsService);
  }
  async loadSettings() {
    var e;
    return (
      this.settings ||
        (this.settings = await (null == (e = this.httpService)
          ? void 0
          : e.post("/api/v1/find-frontend-settings"))),
      this.settings
    );
  }
}
...
const R = "x_wbaas_token_treshold",
  L = () => ({ tries: 1, lastTryTime: Date.now() }),
  j = function (e) {
    let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
    if (!window.localStorage) throw new Error("LocalStorage is not allowed.");
    const r = window.localStorage.getItem(e);
    return null === r
      ? (window.localStorage.setItem(e, JSON.stringify(t)), t)
      : JSON.parse(r);
  },
  V = function (e, t) {
  ...
  q = (e) => {
    ...
    const n = {
      ...
      reqIp:
        (null === (t = document.getElementById("r-ip")) || void 0 === t
          ? void 0
          : t.dataset.reqIp) || "",
      reqId:
        (null === (r = document.getElementById("r-uuid")) || void 0 === r
          ? void 0
          : r.dataset.reqUuid) || "",
      tries: j(R),
    };
    ...
    return {
      ...
      extra: { data: JSON.stringify(n) },
    };
  };
function D(e) {
  let t;
  t = e instanceof Error ? q(e) : e;
  const r = JSON.stringify(t);
  fetch("".concat("/__wbaas/challenges/antibot", "/api/v1/report"), {
    body: r,
    method: "POST",
...
window.addEventListener("DOMContentLoaded", async () => {
  ...
  try {
      ...
      ((function (e) {
        ...
        if (e) {
          const e = (function () {
              ...
              return (
                t.classList.add("wait_msg"),
                (t.textContent = "Проверяем браузер"),
                e.appendChild(t),
                e
              );
            })(),
          ...
          (r.replaceChildren(e, n), t.appendChild(r));
        } else {
          const e = (function () {
            const e = document.createElement("div");
            ...
            return (
              (t.innerHTML =
                "Для работы сайта необходимо включить cookies в настройках вашего браузера и перезагрузить страницу."),
              e.appendChild(t),
              e
            );
          })();
    ...
    if (
      !(function () {
        const e = j(R, L()),
          { tries: t, lastTryTime: r } = e,
          n = Date.now() - r >= 6e4;
        let s = !0;
        return t < 3
          ? ((e.tries += 1), V(R, e), s)
          : (t >= 3 && ((s = !1), n && (V(R, L()), (s = !0))), s);
      })()
    )
      throw new Error("Get token tries exceeded");
    await (async function () {
      try {
        const e = document.querySelector("#s-key"),
          t = String(e.dataset.siteKey),
          r = new P({ baseUrl: "/__wbaas/challenges/antibot", siteKey: t }),
          n = (function () {
            const e = "; "
              .concat(document.cookie)
              .split("; ".concat("x_wbaas_token", "="));
            if (2 === e.length) return e.pop().split(";").shift();
          })();
        (n ? r.createToken({ secureToken: n }) : r.createToken()).then((e) => {
          ((function (e, t) {
            let r =
    ...
    D(s);
    const o = document.querySelector(".support-countdown-text"),
      a = document.querySelector(".support-countdown .clock-icon"),
      c = document.querySelector(".support-countdown .load-icon");
    let l = null,
      d = null,
      u = 59;
    const h = () => {
        null !== l && (window.clearInterval(l), (l = null));
      },
      p = () => {
      ...
      m = (e) => {
        (null == a || a.classList.toggle("is-hidden", e),
          null == c || c.classList.toggle("is-hidden", !e));
      },
      f = (e) => {
        if (!o) return;
        const t = e.toString().padStart(2, "0");
        o.textContent = "Новая попытка через 00:".concat(t);
      },
      w = () => {
        o && ((o.textContent = "Пробуем еще раз..."), m(!0), (u = 0));
      },
      y = function () {
        let e =
          arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 59;
        if (!o) return;
        g();
        const t = e >= 1 ? e : 59;
        ((u = t),
    ...
    if ((o && y(), n)) {
      const e = encodeURIComponent("Ошибка при выдаче токена"),
        t = encodeURIComponent(i),
        r = "mailto:captcha-support@rwb.ru?subject="
          .concat(e, "&body=")
          .concat(t);
      n.addEventListener("click", () => {
        (y(u >= 1 ? u : 59), (window.location.href = r));
      });
    }
  }
});
